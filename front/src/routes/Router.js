...
//Evaluations
const Evaluations = Loadable(lazy(() => import('../views/apps/evaluations/EvaluationsList')));
const Coevaluation = Loadable(lazy(() => import('../views/apps/self-evaluation/SelfCoevaluation')));
//teacher
const Teacher = Loadable(lazy(() => import('../views/apps/teachers/TeachersList')));
const Course = Loadable(lazy(() => import('../views/apps/course/CoursesList')));
//SelfEvaluations
const SelfEvaluations = Loadable(lazy(() => import('../views/apps/self-evaluation/SelfEvaluations')));

//Qualification
const Qualification = Loadable(lazy(() => import('../views/apps/qualifications/QualificationsList')));
const Report = Loadable(lazy(() => import('../views/apps/qualifications/Report')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/teacher/list', element: <Teacher/> },
      { path: '/evaluation', element: <SelfEvaluations/> },
      { path: '/coevaluation', element: <Coevaluation/> },
      { path: '/course/list', element: <Course/> },
      { path: '/evaluations/list', element: <Evaluations/> },
      { path: '/qualification/list', element: <Qualification/> },
